...
const MODEL_PARAM_PRIORITY: ReadonlyMap<string, number> = new Map([
  ...
  ["3d_camera_yaw", 530],
  ["3d_camera_pitch", 520],
  ["3d_camera_distance", 510],
  ["3d_camera_position", 508],
  ["3d_camera_target", 506],
  ["3d_camera_zoom", 504],
  ["3d_light_preset", 500],
  ["3d_controls", 490],
  ["3d_auto_rotate", 480],
  ["3d_turn_table", 475],
  ["3d_turn_table_speed", 474],
  ["3d_turn_table_axis", 473],
  ["3d_bg", 470],
  ["3d_loading", 460],
  ["3d_convert", 450],
  ["3d_convert_force", 440],
  ["3d_convert_scale", 430],
  ["3d_convert_up", 420],
  ["3d_convert_center", 410],
  ["w", 405],
  ["h", 400],
  ["align", 395],
]);

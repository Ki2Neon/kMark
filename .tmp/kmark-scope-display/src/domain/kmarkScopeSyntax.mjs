export const defaultKmarkScopeSyntaxConfig = {
    directiveNames: ["k", "kmark"],
    openScopeToken: "{",
    closeScopeToken: "}",
    allowBareClose: true,
};
export function parseKmarkScopeCommentBody(body, config = defaultKmarkScopeSyntaxConfig) {
...
export function findLastKmarkDirectiveMarker(lineBeforeCursor, config = defaultKmarkScopeSyntaxConfig) {
    let lastMatch = null;
...
function isKmarkDirectiveNameCharacter(character) {

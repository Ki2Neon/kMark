...
pub const KMARK_PARAM_SPECS: &[KmarkParamSpec] = &[
    ...
    KmarkParamSpec {
        ...
        insert_text: "3d_projection:",
        description: "3Dモデルの投影方式を指定する",
        examples: &["<!-- kmark 3d_projection:perspective -->"],
        priority: 94,
    },
    KmarkParamSpec {
        name: "3d_fov",
    ...
    KmarkParamSpec {
        ...
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_camera_yaw:",
        description: "3Dモデルカメラの水平角度を指定する",
        examples: &["<!-- kmark 3d_camera_yaw:45 -->"],
        priority: 92,
    },
    KmarkParamSpec {
        name: "3d_camera_pitch",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_camera_pitch:",
        description: "3Dモデルカメラの上下角度を指定する",
        examples: &["<!-- kmark 3d_camera_pitch:25 -->"],
        priority: 91,
    },
    KmarkParamSpec {
        name: "3d_camera_distance",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_camera_distance:",
        description: "3Dモデル中心からカメラまでの距離を指定する",
        examples: &["<!-- kmark 3d_camera_distance:3 -->"],
        priority: 90,
    },
    KmarkParamSpec {
        name: "3d_camera_position",
        aliases: &[],
        param_type: "vector3",
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_camera_position:",
        description: "3Dモデルカメラの視点位置をx,y,z形式で指定する",
        examples: &["<!-- kmark 3d_camera_position:1,2,3 -->"],
        priority: 90,
    },
    KmarkParamSpec {
        name: "3d_camera_target",
        aliases: &[],
        param_type: "vector3",
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_camera_target:",
        description: "3Dモデルカメラの注視点をx,y,z形式で指定する",
        examples: &["<!-- kmark 3d_camera_target:0,0,0 -->"],
        priority: 89,
    },
    KmarkParamSpec {
        name: "3d_camera_zoom",
        ...
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_camera_zoom:",
        description: "3Dモデルカメラのzoom倍率を指定する",
        examples: &["<!-- kmark 3d_camera_zoom:1.5 -->"],
        priority: 88,
    },
    KmarkParamSpec {
        name: "3d_light_preset",
        aliases: &[],
        param_type: "enum",
        contexts: &["single", "model"],
        values: &["default", "studio", "flat", "product", "none"],
        insert_text: "3d_light_preset:",
        description: "3Dモデル照明presetを指定する",
        examples: &["<!-- kmark 3d_light_preset:studio -->"],
        priority: 87,
    },
    KmarkParamSpec {
        name: "3d_controls",
        ...
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_controls:",
        description: "3Dモデル操作可否を指定する",
        examples: &["<!-- kmark 3d_controls:false -->"],
        priority: 88,
    },
    KmarkParamSpec {
        name: "3d_auto_rotate",
        ...
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_auto_rotate:true",
        description: "3Dモデルの自動回転を有効化する",
        examples: &["<!-- kmark 3d_auto_rotate:true -->"],
        priority: 87,
    },
    KmarkParamSpec {
        name: "3d_turn_table",
        ...
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_turn_table:true",
        description: "3Dモデル本体のターンテーブル回転を有効化する",
        examples: &["<!-- kmark 3d_turn_table:true -->"],
        priority: 87,
    },
    KmarkParamSpec {
        name: "3d_turn_table_speed",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "model"],
        values: &["0.25", "0.5", "1", "2"],
        insert_text: "3d_turn_table_speed:",
        description: "3Dモデル本体のターンテーブル回転速度を指定する",
        examples: &["<!-- kmark 3d_turn_table:true 3d_turn_table_speed:0.5 -->"],
        priority: 86,
    },
    KmarkParamSpec {
        name: "3d_turn_table_axis",
        aliases: &[],
        param_type: "enum",
        contexts: &["single", "model"],
        values: &["z", "x", "y", "-x", "-y", "-z"],
        insert_text: "3d_turn_table_axis:",
        description: "3Dモデル本体のターンテーブル回転軸を指定する 未指定時はZ軸",
        examples: &["<!-- kmark 3d_turn_table:true 3d_turn_table_axis:z -->"],
        priority: 86,
    },
    KmarkParamSpec {
        name: "3d_bg",
    ...
    KmarkParamSpec {
        ...
        contexts: &["single", "model"],
        values: &["lazy", "eager"],
        insert_text: "3d_loading:",
        description: "3Dモデル読み込み方式を指定する",
        examples: &["<!-- kmark 3d_loading:lazy -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "3d_convert",
        ...
        insert_text: "3d_convert:",
        description: "GLB変換制御を指定する",
        examples: &["<!-- kmark 3d_convert:auto -->"],
        priority: 84,
    },
    KmarkParamSpec {
        name: "3d_convert_force",
        aliases: &[],
        param_type: "boolean",
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_convert_force:",
        description: "3DモデルGLB変換を強制する",
        examples: &["<!-- kmark 3d_convert_force:true -->"],
        priority: 83,
    },
    KmarkParamSpec {
        name: "3d_convert_scale",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "model"],
        values: &["0.01", "0.1", "1", "10"],
        insert_text: "3d_convert_scale:",
        description: "3Dモデル変換時倍率を指定する",
        examples: &["<!-- kmark 3d_convert_scale:0.01 -->"],
        priority: 82,
    },
    KmarkParamSpec {
        name: "3d_convert_up",
        ...
        insert_text: "3d_convert_up:",
        description: "3Dモデル変換時の入力上方向軸を指定する Z軸を表示上下に写像する",
        examples: &["<!-- kmark 3d_convert_up:z -->"],
        priority: 81,
    },
    KmarkParamSpec {
        name: "3d_convert_center",
        aliases: &[],
        param_type: "boolean",
        contexts: &["single", "model"],
        values: &[],
        insert_text: "3d_convert_center:",
        description: "3Dモデル変換時に中心補正する",
        examples: &["<!-- kmark 3d_convert_center:true -->"],
        priority: 80,
    },
    KmarkParamSpec {
        name: "color",
    ...
    KmarkParamSpec {
        name: "mermaid_font_size",
        aliases: &[],
        param_type: "length",
        contexts: &["single", "scope", "mermaid"],
        values: &[],
        insert_text: "mermaid_font_size:",
        description: "Mermaid全体の基準font sizeを指定する",
        examples: &["<!-- kmark mermaid_font_size:10 -->"],
        priority: 87,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_font_size",
        aliases: &[],
        param_type: "length",
        contexts: &["single", "scope", "mermaid"],
        values: &[],
        insert_text: "mermaid_gantt_font_size:",
        description: "Mermaid Ganttのtaskとaxis label用font sizeを指定する",
        examples: &["<!-- kmark mermaid_gantt_font_size:10 -->"],
        priority: 86,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_section_font_size",
        aliases: &[],
        param_type: "length",
        contexts: &["single", "scope", "mermaid"],
        values: &[],
        insert_text: "mermaid_gantt_section_font_size:",
        description: "Mermaid Ganttのsection名font sizeを指定する",
        examples: &["<!-- kmark mermaid_gantt_section_font_size:10 -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_auto_bar_size",
        aliases: &[],
        param_type: "boolean",
        contexts: &["single", "scope", "mermaid"],
        values: &["true", "false"],
        insert_text: "mermaid_gantt_auto_bar_size:true",
        description: "Mermaid Ganttのbar height/gapをfont size連動で自動調整する",
        examples: &["<!-- kmark mermaid_gantt_auto_bar_size:true -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_bar_height",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "scope", "mermaid"],
        values: &["auto"],
        insert_text: "mermaid_gantt_bar_height:auto",
        description: "Mermaid Ganttのbar heightを指定する auto指定可",
        examples: &["<!-- kmark mermaid_gantt_bar_height:40 -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_bar_gap",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "scope", "mermaid"],
        values: &["auto"],
        insert_text: "mermaid_gantt_bar_gap:auto",
        description: "Mermaid Ganttのbar gapを指定する auto指定可",
        examples: &["<!-- kmark mermaid_gantt_bar_gap:auto -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_text_line_height",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "scope", "mermaid"],
        values: &[],
        insert_text: "mermaid_gantt_text_line_height:1.25",
        description: "Mermaid Ganttのbar内text line-height係数を指定する",
        examples: &["<!-- kmark mermaid_gantt_text_line_height:1.25 -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_bar_padding_y",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "scope", "mermaid"],
        values: &[],
        insert_text: "mermaid_gantt_bar_padding_y:4",
        description: "Mermaid Ganttのbar内text上下padding pxを指定する",
        examples: &["<!-- kmark mermaid_gantt_bar_padding_y:4 -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_min_bar_height",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "scope", "mermaid"],
        values: &[],
        insert_text: "mermaid_gantt_min_bar_height:20",
        description: "Mermaid Ganttの自動計算時min bar heightを指定する",
        examples: &["<!-- kmark mermaid_gantt_min_bar_height:20 -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_gantt_max_bar_height",
        aliases: &[],
        param_type: "number",
        contexts: &["single", "scope", "mermaid"],
        values: &[],
        insert_text: "mermaid_gantt_max_bar_height:56",
        description: "Mermaid Ganttの自動計算時max bar heightを指定する",
        examples: &["<!-- kmark mermaid_gantt_max_bar_height:56 -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "mermaid_theme",
    ...
    KmarkParamSpec {
        name: "mermaid_background",
        aliases: &[],
        param_type: "color",
        contexts: &["single", "scope", "mermaid"],
        values: &["paper", "transparent", "none"],
        insert_text: "mermaid_background:",
        description: "Mermaid表示枠の背景を指定する",
        examples: &["<!-- kmark mermaid_background:paper -->"],
        priority: 83,
    },
    KmarkParamSpec {
        name: "mermaid_init_merge",
        aliases: &[],
        param_type: "enum",
        contexts: &["single", "scope", "mermaid"],
        values: &["merge", "replace", "user-first", "kmark-first"],
        insert_text: "mermaid_init_merge:merge",
        description: "Mermaid initとkmark設定のmerge優先順を指定する",
        examples: &["<!-- kmark mermaid_init_merge:kmark-first -->"],
        priority: 82,
    },
    KmarkParamSpec {
        name: "font_size",

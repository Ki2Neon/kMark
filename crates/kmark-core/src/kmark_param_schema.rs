...
pub const KMARK_PARAM_SPECS: &[KmarkParamSpec] = &[
    ...
    KmarkParamSpec {
        ...
        param_type: "enum",
        contexts: &["single", "image", "scope", "shape"],
        values: &["none", "soft", "medium", "hard"],
        insert_text: "shadow:",
        description: "対象要素の影を指定する",
        examples: &["<!-- kmark shadow:soft -->"],
        priority: 76,
    },
    KmarkParamSpec {
        name: "margin",
        ...
        values: &[],
        insert_text: "margin:",
        description: "対象要素の外余白を指定する",
        examples: &["<!-- kmark margin:5mm -->"],
        priority: 74,
    },
    KmarkParamSpec {
        name: "padding",
        ...
        values: &[],
        insert_text: "padding:",
        description: "対象要素の内余白を指定する",
        examples: &["<!-- kmark padding:4mm -->"],
        priority: 74,
    },
    KmarkParamSpec {
        name: "layout",

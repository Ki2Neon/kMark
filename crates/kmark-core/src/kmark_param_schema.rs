...
pub const KMARK_PARAM_SCHEMA_VERSION: u32 = 7;
...
pub const KMARK_PARAM_SPECS: &[KmarkParamSpec] = &[
    ...
    KmarkParamSpec {
        name: "page_header_margin_top",
        aliases: &[],
        param_type: "length",
        contexts: &["page", "scope"],
        values: &[],
        insert_text: "page_header_margin_top:",
        description: "ページ上端からヘッダーまでの距離を指定する",
        examples: &["<!-- kmark page_header_margin_top:6mm -->"],
        priority: 86,
    },
    KmarkParamSpec {
        name: "page_footer",
    ...
    KmarkParamSpec {
        name: "page_footer_margin_bottom",
        aliases: &[],
        param_type: "length",
        contexts: &["page", "scope"],
        values: &[],
        insert_text: "page_footer_margin_bottom:",
        description: "ページ下端からフッターまでの距離を指定する",
        examples: &["<!-- kmark page_footer_margin_bottom:6mm -->"],
        priority: 85,
    },
    KmarkParamSpec {
        name: "page_number",
